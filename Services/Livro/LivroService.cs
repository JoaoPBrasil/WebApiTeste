...
using WebApiTeste.Dto.Livro;
using WebApiTeste.Models;

namespace WebApiTeste.Services.Livro
{
    public class LivroService : ILivroInterface
    {
        ...
        public async Task<ResponseModel<LivroModel>> BuscarLivroPorId(int idLivro)
        {
            ...
            try
            {
                var livro = await _context.Livros.Include(a => a.Autor).FirstOrDefaultAsync(livrosBanco => livrosBanco.Id == idLivro);
